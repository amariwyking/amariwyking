...
export default function IntroBio() {
    return (
        <div className="md:justify-self-start mx-0 sm:mx-auto col-span-1 md:col-span-2 order-3">
            <p className="font-work-sans mx-8 sm:mx-8 md:mx-auto mt-6 text-left text-gray-600 text-sm md:text-lg lg:text-2xl ">
