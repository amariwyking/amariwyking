...
export default function IntroBio() {
    return (
        <div className="justify-self-start mx-auto md:col-span-2 order-3">
            <p className="mt-6 text-left text-base text-gray-600 dark:text-gray-400 w-full lg:text-xl md:text-lg">
