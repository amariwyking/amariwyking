 ...
 */
export function getProjectCardTimeline(rootElement: HTMLElement): gsap.core.Timeline {
...
export default function ProjectCard({
  ...
  return (
    <div className="project-card flex w-full max-w-6xl mx-auto justify-center">
      {/* Main Content Grid */}
      <div className="grid grid-cols-1 gap-8 lg:max-w-2/3">
        ...
        <div className="project-details space-y-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold font-kode-mono text-foreground">
              Skills
            </h3>
            <SkillCarousel
